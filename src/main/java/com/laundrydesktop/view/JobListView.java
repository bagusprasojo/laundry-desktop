...
import com.laundrydesktop.service.JasperJobReportService;
...
public class JobListView {
    private final JasperJobReportService jasperJobReportService = new JasperJobReportService();
    ...
    public Parent build() {
        ...
        VBox box = new VBox(12,
                new Label("Laporan Daftar Pekerjaan"),
                filterForm,
                actions
        );
    ...
    private void previewReport() {
        ...
        try {
            ...
            jasperJobReportService.previewJobListReport(start, end);
            infoLabel.setText("Preview JasperReport berhasil dibuka.");
        } catch (Exception e) {
